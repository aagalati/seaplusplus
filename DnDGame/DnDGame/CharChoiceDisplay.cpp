...
CharChoiceDisplay::CharChoiceDisplay() : Display()
{
...
void CharChoiceDisplay::choiceDisplay() {
	...
	for (int i = 0; i < numofbuttons; i++) {
		...
		case 0: bname = "View All";
			...
			break;
		case 1:	bname = "Create custom character";
			_buttonsize.x = 400;
			_buttonsize.y = 300;
...
void CharChoiceDisplay::drawButtons() {
...
void CharChoiceDisplay::openAll() {
...
void CharChoiceDisplay::buttonAction(int x, int y, bool isclick) {
...
int CharChoiceDisplay::getExitType() {

	return -1;

}

CharChoiceDisplay::~CharChoiceDisplay()
{
}
