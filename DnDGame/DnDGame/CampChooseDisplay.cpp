...
CampChooseDisplay::CampChooseDisplay() : Display()
{
...
void CampChooseDisplay::choiceDisplay() {
...
void CampChooseDisplay::drawButtons() {
...
void CampChooseDisplay::openAll() {

	

}

void CampChooseDisplay::openEdit() {
...
void CampChooseDisplay::buttonAction(int x, int y, bool isclick) {
...
int CampChooseDisplay::getExitType() {

	return -1;

}

CampChooseDisplay::~CampChooseDisplay()
{
}
